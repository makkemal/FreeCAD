...
#define YY_NUM_RULES 97	//SvdW: Added one extra rule for the KiloJoule Quantity (case 76)
#define YY_END_OF_BUFFER 98 //SvdW: Added an extra counter to the buffer, otherwise it won't compile
