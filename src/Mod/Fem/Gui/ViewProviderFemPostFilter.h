...
class FemGuiExport ViewProviderFemPostLinearizedStresses : public ViewProviderFemPostObject {

    PROPERTY_HEADER(FemGui::ViewProviderFemPostLinearizedStresses);

public:
    /// constructor.
    ViewProviderFemPostLinearizedStresses();
    ~ViewProviderFemPostLinearizedStresses();
