...
public:
    ...
    bool get_rectangular()const;
    bool get_cylindrical()const;
    static std::string getDisplcementReferences(const std::string showConstr);

private Q_SLOTS:
    void onReferenceDeletedRect(void);
    void onReferenceDeletedCylin(void);
    void Rect();
    void Cyl();
    void addToSelectionRect();
    void removeFromSelectionRect();
    void addToSelectionCylin();
    void removeFromSelectionCylin();
