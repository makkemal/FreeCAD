...
#ifndef FEM_CONSTRAINT1dpipeflow_H
#define FEM_CONSTRAINT1dpipeflow_H
...
class AppFemExport Constraint1dpipeflow : public Fem::Constraint
{
    PROPERTY_HEADER(Fem::Constraint1dpipeflow);

public:
    /// Constructor
    Constraint1dpipeflow(void);
...
#endif // FEM_CONSTRAINT1dpipeflow_H
