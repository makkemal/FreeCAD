...
ConstraintTransform::ConstraintTransform()
{
    ...
    ADD_PROPERTY(Rectangular,(1));
    ADD_PROPERTY(Cylindrical,(0));
    ADD_PROPERTY_TYPE(RefDispl,(0,0),"Constraint",(App::PropertyType)(App::Prop_None),"Elements where the constraint is applied");
    ADD_PROPERTY_TYPE(NameDispl,(0),"Constraint",(App::PropertyType)(App::Prop_None),"Elements where the constraint is applied");
