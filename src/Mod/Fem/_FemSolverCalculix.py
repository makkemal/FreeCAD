...
class _FemSolverCalculix():
    ...
    def __init__(self, obj):
        ...
        obj.addProperty("App::PropertyEnumeration", "GeometricalNonlinearity", "Fem", "Type of g eometrical nonlinearity")
        obj.GeometricalNonlinearity = FemToolsCcx.FemToolsCcx.known_known_geom_nonlinear_types
        obj.GeometricalNonlinearity = FemToolsCcx.FemToolsCcx.known_known_geom_nonlinear_types[0]  # standard is linear
