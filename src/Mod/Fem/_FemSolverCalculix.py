...
class _FemSolverCalculix():
    ...
    def __init__(self, obj):
        ...
        if geom is True:
            obj.GeometricalNonlinearity = FemToolsCcx.FemToolsCcx.known_geom_nonlinear_types[1]  # nonlinear
        else:
            obj.GeometricalNonlinearity = FemToolsCcx.FemToolsCcx.known_geom_nonlinear_types[0]  # linear
