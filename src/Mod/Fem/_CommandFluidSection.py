...
class _CommandFluidSection(FemCommands):
    ...
    def Activated(self):
        ...
        FreeCADGui.addModule("FemFluidSection")
        FreeCADGui.doCommand("FemGui.getActiveAnalysis().Member = FemGui.getActiveAnalysis().Member + [FemFluidSection.makeFemFluidSection()]")
